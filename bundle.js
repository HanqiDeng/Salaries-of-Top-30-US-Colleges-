(function (d3$1, topojson) {
  ...
  d3$1.json(countyURL).then( (data) => {
    ...
    d3$1.csv("https://raw.githubusercontent.com/Lily-Deng/Salaries-of-Top-30-US-Colleges-/main/Wages.csv").then( (data) => {
    	wageData = data;
  ...
  d3.csv("https://raw.githubusercontent.com/Lily-Deng/Salaries-of-Top-30-US-Colleges-/main/top-30.csv").then( (data) => {
    data.forEach( d => {
  ...
  d3.csv("https://raw.githubusercontent.com/Lily-Deng/Salaries-of-Top-30-US-Colleges-/main/mid-career.csv").then( (data) => {
